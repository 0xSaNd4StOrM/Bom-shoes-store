...
export const translations = {
  en: {
    ...
    homeNewsletterAlready: 'You are already on our list.',
    homeNewsletterError: 'Something went wrong. Please try again.',
    ...
    cartShipAtCheckout: 'Calculated at checkout',
    cartFree: 'Free',
    cartTax: 'Tax (est.)',
    cartTotal: 'Total',
    ...
    checkoutCashDesc: 'Pay in cash when your order arrives. We\'ll confirm it and prepare it for delivery right away.',
    checkoutPlaceOrder: (amount: string) => `Place order, ${amount}`,
    ...
    successCodDesc: 'Your order is confirmed! You\'ll pay in cash when it\'s delivered. We\'re preparing it now.',
    ...
    adminClose: 'Close',
    adminGenericError: 'Something went wrong',
    adminDiscount: 'Discount',
    adminDiscountType: 'Discount type',
    adminPercentage: 'Percentage',
    adminFixedAmount: 'Fixed amount',
    adminFreeShipping: 'Free shipping',
    adminDiscountPercentField: 'Discount (%)',
    adminDiscountAmountField: (currency: string) => `Discount (${currency})`,
    adminSaveBtn: 'Save',
    ...
    adminBannerCol: 'Banner',
    adminBannerCta: 'CTA',
    adminNoBanners: 'No banners yet',
    adminEditBanner: 'Edit banner',
    adminNewBanner: 'New banner',
    adminDeleteBanner: 'Delete banner',
    adminBannerTitleField: 'Title',
    adminBannerSubtitle: 'Subtitle',
    adminBannerCtaText: 'CTA text',
    adminBannerCtaLink: 'CTA link',
    adminImageUrl: 'Image URL',
    adminPosition: 'Position',
    adminBannerTitleRequired: 'Title is required',
    adminBannerUpdated: 'Banner updated',
    ...
    adminCouponStackable: 'Stackable',
    adminCouponUsage: 'Usage',
    adminCouponDates: 'Dates',
    adminCouponAutoApply: 'Auto-apply',
    adminNoCoupons: 'No coupons yet',
    adminEditCoupon: 'Edit coupon',
    adminNewCoupon: 'New coupon',
    adminDeleteCoupon: 'Delete coupon',
    adminRequiresCode: 'Requires a code',
    adminAppliesAutomatically: 'Applies automatically',
    adminBuyQuantity: 'Buy quantity',
    adminGetQuantity: 'Get quantity',
    adminGetDiscountPercent: 'Get discount (%)',
    adminBuyXGetY: 'Buy X Get Y',
    adminMinOrderAmount: (currency: string) => `Min order amount (${currency})`,
    adminMaxDiscountAmount: (currency: string) => `Max discount amount (${currency})`,
    adminUsageLimit: 'Usage limit (total)',
    adminPerCustomerLimit: 'Per-customer limit',
    adminStartsAt: 'Starts at',
    adminEndsAt: 'Ends at',
    adminStackableLabel: 'Stackable with a qualifying bundle',
    adminAppliesTo: 'Applies to',
    adminWholeOrder: 'Whole order',
    adminACategory: 'A category',
    adminSpecificProducts: 'Specific products',
    adminSelectCategory: 'Select a category',
    adminNoProductsYet: 'No products yet',
    adminCodeRequired: 'A code is required unless this coupon applies automatically',
    ...
    adminDiscountFixedOff: (amount: string) => `${amount} off`,
    ...
    adminSystem: 'System',
    adminCollapseDetails: 'Collapse details',
    ...
    adminMessageEnglish: 'Message (English)',
    adminMessageArabic: 'Message (Arabic)',
    adminContactSocial: 'Contact & Social',
    adminAddressEnglish: 'Address (English)',
    adminAddressArabic: 'Address (Arabic)',
    adminMapUrl: 'Map URL',
    adminInstagramUrl: 'Instagram URL',
    adminFacebookUrl: 'Facebook URL',
    adminTiktokUrl: 'TikTok URL',
    adminTwitterUrl: 'Twitter / X URL',
    adminBothNamesRequired: 'Both English and Arabic names are required',
    adminCouldNotAddCategory: 'Could not add category',
    adminCategoryInUse: (count: number) => `${count} product(s) still use this category`,
    adminCategoryDeleted: 'Category deleted',
    adminDelete: 'Delete',
    adminPaymentMethods: 'Payment methods',
    adminPaymentMethodsHint: 'Choose which payment options appear at checkout. At least one must stay enabled.',
    adminAtLeastOnePayment: 'At least one payment method must stay enabled.',
    ...
    adminPhotos: 'Photos',
    adminUploadImages: '+ Upload images',
    adminSaveFirstForPhotos: 'Save the product first to add photos',
    ...
    adminLimitedDropTab: 'Limited Drop',
    adminTrustBadgesTab: 'Trust Badges',
    adminBrandBarTab: 'Brand Bar',
    ...
    adminFieldSubtitle: 'Subtitle',
    adminFieldPrimaryCtaText: 'Primary CTA text',
    adminFieldPrimaryCtaLink: 'Primary CTA link',
    adminFieldSecondaryCtaText: 'Secondary CTA text',
    adminFieldSecondaryCtaLink: 'Secondary CTA link',
    adminFieldScrollHint: 'Scroll hint text',
    adminFieldHeading: 'Heading',
    adminFieldViewAllText: '"View all" link text',
    adminFieldProductLimit: 'Product limit',
    adminFieldCtaText: 'CTA text',
    adminFieldCtaLink: 'CTA link',
    adminFieldTitle: 'Title',
    adminFieldDescription: 'Description',
    adminFieldLabel: 'Label',
    adminFieldUrl: 'URL',
    adminCountdownMode: 'Countdown mode',
    adminCountdownAuto: 'Auto (7 days from now)',
    adminCountdownManual: 'Manual target date',
    adminCountdownOff: 'Off',
    adminManualTarget: 'Manual target',
    adminShowSection: 'Show this section on the homepage',
    adminShowcaseProducts: 'Products (in showcase order)',
    adminSelectProductToAdd: 'Select a product to add',
    adminNoShowcaseProducts: 'No products in the showcase yet',
    adminAdd: 'Add',
    adminBadges: 'Badges',
    adminAddBadge: '+ Add badge',
    adminRemoveBadge: 'Remove badge',
    adminNoBadges: 'No badges yet',
    adminLines: 'Lines',
    adminAddLine: '+ Add line',
    adminLineN: (n: number) => `Line ${n}`,
    adminRemoveLine: 'Remove line',
    adminNoLines: 'No lines yet',
    adminLinks: 'Links',
    adminAddLink: '+ Add link',
    adminLinkN: (n: number) => `Link ${n}`,
    adminRemoveLink: 'Remove link',
    adminNoLinks: 'No links yet',
    adminBrandBarNote: 'The brand bar shows your brands (as names, or logos once uploaded) below the hero. Its contents come from your Brands list -- use the toggle below to show or hide the whole bar on the homepage.',
    ...
    adminAuthorName: 'Author name',
    adminAuthorTitle: 'Author title',
    adminAuthorTitlePlaceholder: 'e.g. Verified buyer',
    adminQuoteEn: 'Quote (EN)',
    adminQuoteAr: 'Quote (AR)',
    adminRating15: 'Rating (1-5)',
    adminAvatarUrl: 'Avatar URL',
    adminAuthorNameRequired: 'Author name is required',
    adminQuoteRequired: 'Quote is required in both languages',
    adminTestimonialDeleteConfirm: (name: string) => `Delete testimonial from "${name}"?`,
    adminTestimonialUpdated: 'Testimonial updated',
    adminTestimonialCreated: 'Testimonial created',
    adminTestimonialDeleted: 'Testimonial deleted',
  ...
  ar: {
    ...
    homeNewsletterAlready: 'أنت مشترك بالفعل في قائمتنا.',
    homeNewsletterError: 'حدث خطأ ما. يرجى المحاولة مرة أخرى.',
    ...
    cartShipping: 'الشحن',
    cartShipAtCheckout: 'يُحسب عند الدفع',
    cartFree: 'مجاني',
    ...
    successCodDesc: 'تم تأكيد طلبك! ستدفع نقدًا عند الاستلام. نجهّز طلبك الآن.',
    ...
    adminClose: 'إغلاق',
    adminGenericError: 'حدث خطأ ما',
    adminDiscount: 'الخصم',
    adminDiscountType: 'نوع الخصم',
    adminPercentage: 'نسبة مئوية',
    adminFixedAmount: 'مبلغ ثابت',
    adminFreeShipping: 'شحن مجاني',
    adminDiscountPercentField: 'الخصم (%)',
    adminDiscountAmountField: (currency: string) => `الخصم (${currency})`,
    adminSaveBtn: 'حفظ',
    adminCreateBtn: 'إنشاء',
    ...
    adminBannerCol: 'اللافتة',
    adminBannerCta: 'زر الدعوة',
    adminNoBanners: 'لا لافتات بعد',
    adminEditBanner: 'تعديل اللافتة',
    adminNewBanner: 'لافتة جديدة',
    adminDeleteBanner: 'حذف اللافتة',
    adminBannerTitleField: 'العنوان',
    adminBannerSubtitle: 'العنوان الفرعي',
    adminBannerCtaText: 'نص زر الدعوة',
    adminBannerCtaLink: 'رابط زر الدعوة',
    adminImageUrl: 'رابط الصورة',
    adminPosition: 'الموضع',
    adminBannerTitleRequired: 'العنوان مطلوب',
    adminBannerUpdated: 'تم تحديث اللافتة',
    ...
    adminCouponStackable: 'قابل للدمج',
    adminCouponUsage: 'الاستخدام',
    adminCouponDates: 'التواريخ',
    adminCouponAutoApply: 'تلقائي',
    adminNoCoupons: 'لا كوبونات بعد',
    adminEditCoupon: 'تعديل الكوبون',
    adminNewCoupon: 'كوبون جديد',
    adminDeleteCoupon: 'حذف الكوبون',
    adminRequiresCode: 'يتطلب كودا',
    adminAppliesAutomatically: 'يطبق تلقائيا',
    adminBuyQuantity: 'كمية الشراء',
    adminGetQuantity: 'الكمية المجانية',
    adminGetDiscountPercent: 'خصم الكمية المجانية (%)',
    adminBuyXGetY: 'اشتر واحصل على',
    adminMinOrderAmount: (currency: string) => `الحد الأدنى للطلب (${currency})`,
    adminMaxDiscountAmount: (currency: string) => `الحد الأقصى للخصم (${currency})`,
    adminUsageLimit: 'حد الاستخدام (الإجمالي)',
    adminPerCustomerLimit: 'الحد لكل عميل',
    adminStartsAt: 'يبدأ في',
    adminEndsAt: 'ينتهي في',
    adminStackableLabel: 'قابل للدمج مع حزمة مؤهلة',
    adminAppliesTo: 'ينطبق على',
    adminWholeOrder: 'كامل الطلب',
    adminACategory: 'فئة معينة',
    adminSpecificProducts: 'منتجات محددة',
    adminSelectCategory: 'اختر فئة',
    adminNoProductsYet: 'لا منتجات بعد',
    adminCodeRequired: 'الكود مطلوب إلا إذا كان الكوبون يطبق تلقائيا',
    ...
    adminDiscountFixedOff: (amount: string) => `خصم ${amount}`,
    ...
    adminSystem: 'النظام',
    adminCollapseDetails: 'طي التفاصيل',
    ...
    adminCategoryAdded: 'تمت إضافة الفئة',
    adminWhatsapp: 'واتساب',
    adminPhoneNumber: 'رقم الهاتف',
    adminMessageEnglish: 'الرسالة (بالإنجليزية)',
    adminMessageArabic: 'الرسالة (بالعربية)',
    adminContactSocial: 'التواصل والسوشيال ميديا',
    adminAddressEnglish: 'العنوان (بالإنجليزية)',
    adminAddressArabic: 'العنوان (بالعربية)',
    adminMapUrl: 'رابط الخريطة',
    adminInstagramUrl: 'رابط إنستغرام',
    adminFacebookUrl: 'رابط فيسبوك',
    adminTiktokUrl: 'رابط تيك توك',
    adminTwitterUrl: 'رابط تويتر / إكس',
    adminBothNamesRequired: 'الاسمان بالإنجليزية والعربية مطلوبان',
    adminCouldNotAddCategory: 'تعذرت إضافة الفئة',
    adminCategoryInUse: (count: number) => `${count} منتج ما زال يستخدم هذه الفئة`,
    adminCategoryDeleted: 'تم حذف الفئة',
    adminDelete: 'حذف',
    adminPaymentMethods: 'طرق الدفع',
    adminPaymentMethodsHint: 'اختر طرق الدفع التي تظهر عند الدفع. يجب أن تبقى طريقة واحدة على الأقل مفعّلة.',
    adminAtLeastOnePayment: 'يجب أن تبقى طريقة دفع واحدة على الأقل مفعّلة.',
    ...
    adminBrandAdded: 'تمت إضافة الماركة',
    ...
    adminPhotos: 'الصور',
    adminUploadImages: '+ رفع صور',
    adminSaveFirstForPhotos: 'احفظ المنتج أولا لإضافة الصور',
    adminVariants: 'المتغيرات',
    adminColSize: 'المقاس',
    adminColColor: 'اللون',
    adminColStock: 'المخزون',
    ...
    adminLimitedDropTab: 'إصدار محدود',
    adminTrustBadgesTab: 'شارات الثقة',
    adminBrandBarTab: 'شريط الماركات',
    ...
    adminFieldSubtitle: 'العنوان الفرعي',
    adminFieldPrimaryCtaText: 'نص الزر الرئيسي',
    adminFieldPrimaryCtaLink: 'رابط الزر الرئيسي',
    adminFieldSecondaryCtaText: 'نص الزر الثانوي',
    adminFieldSecondaryCtaLink: 'رابط الزر الثانوي',
    adminFieldScrollHint: 'نص تلميح التمرير',
    adminFieldHeading: 'العنوان',
    adminFieldViewAllText: 'نص رابط "عرض الكل"',
    adminFieldProductLimit: 'حد المنتجات',
    adminFieldCtaText: 'نص الزر',
    adminFieldCtaLink: 'رابط الزر',
    adminFieldTitle: 'العنوان',
    adminFieldDescription: 'الوصف',
    adminFieldLabel: 'التسمية',
    adminFieldUrl: 'الرابط',
    adminCountdownMode: 'وضع العد التنازلي',
    adminCountdownAuto: 'تلقائي (7 أيام من الآن)',
    adminCountdownManual: 'تاريخ مستهدف يدوي',
    adminCountdownOff: 'إيقاف',
    adminManualTarget: 'التاريخ المستهدف',
    adminShowSection: 'إظهار هذا القسم في الصفحة الرئيسية',
    adminShowcaseProducts: 'المنتجات (بترتيب العرض)',
    adminSelectProductToAdd: 'اختر منتجا لإضافته',
    adminNoShowcaseProducts: 'لا منتجات في العرض بعد',
    adminAdd: 'إضافة',
    adminBadges: 'الشارات',
    adminAddBadge: '+ إضافة شارة',
    adminRemoveBadge: 'إزالة الشارة',
    adminNoBadges: 'لا شارات بعد',
    adminLines: 'السطور',
    adminAddLine: '+ إضافة سطر',
    adminLineN: (n: number) => `السطر ${n}`,
    adminRemoveLine: 'إزالة السطر',
    adminNoLines: 'لا سطور بعد',
    adminLinks: 'الروابط',
    ...
    adminColAuthor: 'صاحب الرأي',
    adminColQuote: 'الاقتباس',
    adminColRating: 'التقييم',
    adminColActive: 'نشط',
    adminAuthorName: 'اسم صاحب الرأي',
    adminAuthorTitle: 'صفة صاحب الرأي',
    adminAuthorTitlePlaceholder: 'مثال: مشتر موثق',
    adminQuoteEn: 'الاقتباس (بالإنجليزية)',
    adminQuoteAr: 'الاقتباس (بالعربية)',
    adminRating15: 'التقييم (1-5)',
    adminAvatarUrl: 'رابط الصورة الرمزية',
    adminAuthorNameRequired: 'اسم صاحب الرأي مطلوب',
    adminQuoteRequired: 'الاقتباس مطلوب باللغتين',
    adminTestimonialDeleteConfirm: (name: string) => `حذف رأي "${name}"؟`,
    adminTestimonialUpdated: 'تم تحديث الرأي',
    adminTestimonialCreated: 'تم إنشاء الرأي',
    adminTestimonialDeleted: 'تم حذف الرأي',
